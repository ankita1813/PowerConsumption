...
public class EconomicTimes {
    ...
    public void SearchAnApp() throws InterruptedException {
        ...
        Thread.sleep(1000);
        dr.findElementById("launcher3.android.com.hivelauncher:id/et_search").sendKeys("ET");
        dr.findElementByXPath("//android.widget.TextView[@index='1']").click();
        Thread.sleep(2000);
        dr.findElementById("com.et.reader.activities:id/row_item_headline");
